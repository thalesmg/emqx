...
-spec v2_list_bridges_on_nodes_v7([node()], emqx_bridge_v2:root_cfg_key(), map()) ->
    emqx_rpc:erpc_multicall([emqx_resource:resource_data()]).
v2_list_bridges_on_nodes_v7(Nodes, ConfRootKey, Opts) ->
    erpc:multicall(
        Nodes, emqx_bridge_v2_api, list_from_local_node_v7, [ConfRootKey, Opts], ?TIMEOUT
    ).
