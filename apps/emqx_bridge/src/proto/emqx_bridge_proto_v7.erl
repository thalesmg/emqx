...
v2_wait_for_ready_v7(Nodes, ConfRootKey, Type, Name, WaitTimeout, RPCTimeout) ->
    erpc:multicall(
        Nodes,
        emqx_bridge_v2_api,
        wair_for_ready_local_node_v7,
        [ConfRootKey, Type, Name, WaitTimeout],
        RPCTimeout
    ).
