...
matching_transformations(Topic) ->
    ...
    Transformations1 = lists:sort(fun({Pos1, _V1}, {Pos2, _V2}) -> Pos1 =< Pos2 end, Transformations0),
...
create_tables() ->
    _ = emqx_utils_ets:new(?TRANSFORMATION_TOPIC_INDEX, [public, ordered_set, {read_concurrency, true}]),
